...
/// <summary>
/// Service interface for runtime form execution operations.
/// </summary>
public interface IRuntimeService
{
    ...
    /// <summary>
    /// Get form instance by ID with form definition.
    /// </summary>
    ...
    /// <summary>
    /// Submit form instance with validation.
    /// </summary>
    /// <param name="instanceId">Instance identifier</param>
    /// <param name="dataJson">Complete form data in JSON format</param>
    /// <returns>Submitted form instance</returns>
